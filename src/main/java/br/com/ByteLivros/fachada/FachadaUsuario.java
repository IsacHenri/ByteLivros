...
import br.com.ByteLivros.dao.IDAO;
...
public class FachadaUsuario implements IFachada {

    private UsuarioDAO dao;
    private List<IStrategy> estrategias;

    public FachadaUsuario(UsuarioDAO dao) {
        this.dao = dao;
    ...
    public String salvar(EntidadeDominio entidade) {
        ...
        for (IStrategy estrategia : estrategias) {
            String msg = estrategia.processar(usuario);
            if (msg != null) {
                msgs.append(msg);
            }
        }
